...
- markie_check_md: read a document back and report what will not display: a picture that is not where it says it is, an embed of a kind Markie cannot draw, a tag that gets dropped. Run it after writing anything with a picture, a clip or inline HTML in it.
