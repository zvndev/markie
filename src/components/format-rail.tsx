...
const COMMON: RailButton[] = [
  ...
  { key: "bold", label: textMark("B", "text-[13px] font-bold"), title: "Bold (⌘B)", run: (e) => e.chain().focus().toggleBold().run(), active: (s) => s.bold },
  { key: "italic", label: textMark("I", "font-serif text-[13px] italic"), title: "Italic (⌘I)", run: (e) => e.chain().focus().toggleItalic().run(), active: (s) => s.italic },
