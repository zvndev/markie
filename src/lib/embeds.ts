...
//
// server/src/embeds.ts is a copy of this file: the server deliberately imports
// nothing from the app's module graph, and the two test suites pin the same
// examples so the copies cannot drift.
//
